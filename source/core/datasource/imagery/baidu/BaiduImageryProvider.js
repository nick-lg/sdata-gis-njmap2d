...
class BaiduImageryProvider {
  constructor(options = {}) {
    ...
    this._minimumLevel = typeof options.minimumLevel == "number" ? Math.floor(options.minimumLevel) : 1;
    this._maximumLevel = typeof options.maximumLevel == "number" ? Math.floor(options.maximumLevel) : 18;
